 ...
 */
public class TotalNgram extends Configured implements Tool {
    ...
    public static class RecordCounterMapper extends OneGramMapper<Text, LongWritable> {
        ...
        protected void map(OneGram record, Context context) throws IOException, InterruptedException {
            ...
            context.write(TOTAL_COUNT, longWritable);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        int result = ToolRunner.run(new Configuration(), new TotalNgram(), args);
        System.exit(result);
    }
