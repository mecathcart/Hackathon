 ...
 */
public class NgramWordMatchCounter extends Configured implements Tool {

    public enum Count {
        WORD_COUNT
    }

    public static class RecordCounterMapper extends OneGramMapper<Text, LongWritable> {
        ...
        @Override
        protected void map(OneGram record, Context context) throws IOException, InterruptedException {

            Text gram = new Text(record.getGram1());
    ...
    public static void main(String[] args) throws Exception {
        int result = ToolRunner.run(new Configuration(), new NgramWordMatchCounter(), args);
        System.exit(result);
    }
